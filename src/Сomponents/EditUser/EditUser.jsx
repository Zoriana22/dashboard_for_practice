  ...
  return (
    <>
      ...
      <div className={styles.edit_inputs}>
        {getUserValue&&getUserValue.map((userValue) => {
          return (
        ...
        <><label className={styles.edit_label_item}>
              <input
                name="name"
                placeholder="name"
                className={styles.edit_input_item}>{userValue.name}
              </input>

            </label><label className={styles.edit_label_item}>
                <input
                  name="surname"
                  placeholder="surname"
                  className={styles.edit_input_item}>{userValue.surname}
                </input>
                ...
                <input
                  ...
                  className={styles.edit_input_item}>{userValue.phone}
                </input>
                ...
                <input
                  name="email"
                  placeholder="email"
                  className={styles.edit_input_item}>{userValue.email}
                </input>
